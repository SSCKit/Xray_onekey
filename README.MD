...
## Xray 基于 Nginx 的 VLESS + XTLS 一键安装脚本 <img src="https://raw.githubusercontent.com/SSCKit/Xray_onekey/main/image/project_xray.jpg" alt="Project_Xray" width="122" height="30" align="bottom" />
...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/SSCKit/Xray_onekey/nginx_forward/install.sh" && chmod +x install.sh && bash install.sh
```
...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/SSCKit/Xray_onekey/main/install.sh" && chmod +x install.sh && bash install.sh
```
